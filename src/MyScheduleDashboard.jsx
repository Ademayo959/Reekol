        ...
        <div className="w-full px-6 pt-6 bg-gray-100 h-full">
            <div>
                <div className="flex justify-between items-center">
                    <p className="text-[40px] font-bricolage-semibold">My Schedule</p>
                    <p className="text-gray-600">Thursday, <span className="text-green font-bricolage-semibold">11th of January 2026</span></p>
                </div>
                <div className="flex justify-between my-4 items-center">
                    ...
                    <div className="text-end leading-6">
                        ...
                        <p className="text-[20px] m-0 font-bricolage-semibold">7th of January 2026 - 14th of January 2026</p>
                    </div>
                </div>
