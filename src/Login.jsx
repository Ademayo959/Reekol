            ...
            <div className="w-full h-screen grid grid-cols-2 max-sm:grid-cols-1">
                ...
                <div className='my-auto max-sm:w-full'>
                    <div className='max-sm:px-4'>
                        <p className='text-center text-[36px] max-sm:w-full max-sm:leading-12'>Welcome Back to Reekol!</p>
                        ...
                        <div className='w-100 m-auto my-3 max-sm:w-full'>
                            ...
                            <div className='flex justify-between'>
                                <div className='flex gap-2 border border-gray-200 p-2 w-fit rounded-lg px-11 max-sm:px-8'>
